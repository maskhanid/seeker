<p align="center"><img src="https://i.imgur.com/i3A2hkc.jpeg"></p>

<p align="center">
    <a href="https://wa.me/6283141471040">
      <img src="https://img.shields.io/badge/-WhatsApp-black?logo=twitter&style=for-the-badge">
    </a>
    &nbsp;
    <a href="https://maskhandev.me/">
      <img src="https://img.shields.io/badge/-Website-black?logo=&style=for-the-badge">
    </a>
</p>
...
<p>
  <a style="margin-right: 10px;" href="https://github.com/maskhanid/seeker#installation">
    <img src="https://dabuttonfactory.com/button.png?t=INSTALL&f=Open+Sans&ts=15&tc=000&hp=25&vp=10&c=5&bgt=unicolored&bgc=00e2ff">
  </a>
  <a style="margin-right: 10px;" href="https://github.com/maskhanid/seeker#usage">
    <img src="https://dabuttonfactory.com/button.png?t=USAGE&f=Open+Sans&ts=15&tc=000&hp=25&vp=10&c=5&bgt=unicolored&bgc=00e2ff">
  </a>
</p>

Concept behind Seeker is simple, just like we host phishing pages to get credentials why not host a fake page that requests your location like many popular location based websites. Read more on <a href="https://maskhandev.me"> My Website </a>.Seeker Hosts a fake website which asks for Location Permission and if the target allows it, we can get :
...
```bash
docker pull maskhanid/seeker
```

### OSX
```bash
git clone https://github.com/maskhanid/seeker.git
cd seeker/
python3 seeker.py
````
...
# Step 2
$ docker run --rm -it --net ngroknet --name seeker maskhanid/seeker
